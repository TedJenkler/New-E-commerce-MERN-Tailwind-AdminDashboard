...
function Homepage() {
  return (
    <section>
      ...
      <div className='xsm:bg-hero2md bg-cover mb-6 relative bg-darkorange bg-hero2 bg-no-repeat bg-center text-white mx-6 rounded-lg flex flex-col items-center text-center pb-14 md:mx-10 md:px-40 md:pb-16 md:bg-hero2md md:mb-8 xl:mx-40 xl:flex-row xl:p-0 xl:bg-hero2xl xl:mb-12 xl:pt-32 xl:items-start'>
        ...
        <div className='xl:w-1/2 xl:flex xl:flex-col xl:justify-start'>
          ...
          <p className='xsm:mx-20 sm:mx-36 md:mx-0 lmd:mx-20 text-sbase text-white opacity-75 font-medium mx-6 mb-6 md:mb-10 xl:mr-20 xl:ml-40 xl:text-start'>Upgrade to premium speakers that are phenomenally built to deliver truly remarkable sound.</p>
          <Link to="/product/zx9-speaker" className='btn-b xl:max-w-[160px] xl:ml-40'>SEE PRODUCT</Link>
        </div>
      </div>
      <div className='base:bg-hero3md sm:bg-cover bg-hero3 bg-right bg-no-repeat py-24 mx-6 rounded-lg mb-6 px-6 md:bg-hero3md md:mx-10 md:px-16 md:mb-8 xl:bg-hero3xl xl:mx-40 xl:min-h-[320px] xl:bg-cover xl:p-24 xl:mb-12'>
