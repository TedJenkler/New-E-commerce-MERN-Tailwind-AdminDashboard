...
function Homepage() {
  return (
    <section>
      <div className='bg-black1 text-white bg-hero bg-no-repeat bg-center py-28 flex flex-col text-center items-center border-t border-bordergrey/25 mb-24 md:px-48 md:pt-32 md:pb-40 md:bg-heromd md:mb-36 xl:flex-row xl:px-40 xl:bg-heroxl xl:bg-[right_4rem_bottom]'>
        <div className='xl:w-1/2 xl:flex xl:flex-col xl:items-start'>
          ...
          <Link to="/product/xx99-mark-two-headphones" className='bg-darkorange hover:bg-lightorange text-sm font-bold px-8 py-4'>SEE PRODUCT</Link>
        </div>
      ...
      <div className='mb-6 relative bg-darkorange bg-hero2 bg-no-repeat text-white mx-6 rounded-lg flex flex-col items-center text-center pb-14 md:mx-10 md:px-40 md:pb-16 md:bg-hero2md md:mb-8 xl:mx-40 xl:flex-row xl:p-0 xl:bg-hero2xl xl:mb-12 xl:pt-32 xl:items-start'>
        ...
        <div className='xl:w-1/2 xl:flex xl:flex-col xl:justify-start'>
          ...
          <Link to="/product/zx9-speaker" className='bg-black2 hover:bg-hoverblack px-8 py-4 text-sm font-bold tracking-[1px] xl:ml-40 xl:max-w-[160px] xl:px-0'>SEE PRODUCT</Link>
        </div>
      </div>
      <div className='bg-hero3 bg-right bg-no-repeat py-24 mx-6 rounded-lg mb-6 px-6 md:bg-hero3md md:mx-10 md:px-16 md:mb-8 xl:bg-hero3xl xl:mx-40 xl:min-w-[1110px] xl:min-h-[320px] xl:bg-cover xl:p-24 xl:mb-12'>
        ...
        <Link to="/product/zx7-speaker" className='px-8 py-4 border border-black2 hover:bg-black2 hover:text-white text-sm tracking-[1px] font-bold'>SEE PRODUCT</Link>
      </div>
