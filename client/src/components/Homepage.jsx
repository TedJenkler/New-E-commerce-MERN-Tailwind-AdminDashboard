...
function Homepage() {
  return (
    <section>
      <div className='bg-black1 text-white min-h-[37.5rem] bg-hero bg-no-repeat bg-bottom py-28 flex flex-col text-center items-center border-t border-bordergrey/25 md:min-h-[39.938rem] mb-24 md:px-48 md:pt-32 md:pb-40 md:bg-heromd md:mb-36 xl:flex-row xl:px-40 xl:bg-heroxl xl:bg-[right_4rem_bottom]'>
        <div className='xl:w-1/2 xl:flex xl:flex-col xl:items-start'>
          ...
          <p className='mx-10 xsm:mx-24 sm:mx-40 md:mx-0 text-bordergrey text-sbase font-medium mb-8 leading-[20px] md:mb-12 lmd:mx-20 l:mx-40 xl:text-start xl:mx-0 xl:mr-40'>Experience natural, lifelike audio and exceptional build quality made for the passionate music enthusiast.</p>
      ...
      <div className='xsm:bg-hero2md min-h-[37.5rem] bg-cover mb-6 relative bg-darkorange bg-hero2 bg-no-repeat bg-center text-white mx-6 rounded-lg flex flex-col items-center text-center pb-14 md:min-h-[45rem] md:mx-10 md:px-40 md:pb-16 md:bg-hero2md md:mb-8 xl:mx-40 xl:flex-row xl:p-0 xl:bg-hero2xl xl:mb-12 xl:pt-32 xl:items-start'>
        ...
        <div className='xl:w-1/2 xl:flex xl:flex-col xl:justify-start'>
          ...
          <p className='xsm:mx-20 sm:mx-36 md:mx-0 lmd:mx-20 text-sbase leading-[25px] text-white opacity-75 font-medium mx-6 mb-10 md:mb-12 xl:mr-20 xl:ml-40 xl:text-start'>Upgrade to premium speakers that are phenomenally built to deliver truly remarkable sound.</p>
      ...
      <div className='mx-6 md:flex md:mx-10 md:gap-3 md:mb-24 xl:mx-40 xl:gap-8 xl:mb-52 md:min-h-[20rem]'>
        <div className='xl:w-1/2 md:w-full md:min-h-[20rem]'>
          <img className='mb-6 base:w-full md:mb-0 md:min-h-[20rem] xl:hidden xl:absolute' src={yx1} alt='yx1' />
          <img className='hidden absolute contain md:mb-0 xl:min-h-[20rem] xl:min-w-[33.75rem] xl:flex xl:relative' src={yx1xl} alt='yx1' />
        </div>
        <div className='py-10 px-6 bg-greywhite min-h-[12.5rem] rounded-lg mb-32 md:min-h-[20rem] md:w-full md:mb-0 xl:w-full xl:p-24'>
