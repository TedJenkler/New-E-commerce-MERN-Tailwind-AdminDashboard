      ...
      <section>
        <div className='md:flex md:gap-16 md:mb-32 xl:gap-32 xl:mb-40'>
          <div className='md:bg-greywhite md:min-h-[480px] md:w-72 md:rounded-lg md:flex md:items-center xl:w-1/2 xl:bg-white'>
            <img className='mb-8 md:mb-0 xl:absolute xl:hidden' src={product ? product.img : null} alt="product img"/>
        ...
        <div className='xl:flex xl:gap-32 xl:mb-40'>
          <div className='xl:w-[57%]'>
            <h2 className='text-2xl text-black2 font-bold mb-6 tracking-[0.86px] xl:mb-8'>FEATURES</h2>
          ...
          <div className='md:flex md:justify-between'>
            <div>
              <h2 className='text-2xl text-black2 font-bold mb-6 tracking-[0.86px] md:text-32xl md:tracking-[1.14px] xl:mb-8'>IN THE BOX</h2>
